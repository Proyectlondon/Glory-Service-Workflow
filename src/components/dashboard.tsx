...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 border-b border-black/5 dark:border-white/10 bg-background/70 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentView("dashboard")}>
            <div className="flex h-9 w-auto items-center justify-center overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 rounded-xl border-border bg-card">
                <div className="px-3 py-2 cursor-pointer" onClick={() => setCurrentView("dashboard")}>
                ...
                <div className="px-3 py-1.5">
                  <div className="flex items-center gap-2">
                    <Badge
                      ...
                      style={{
                        backgroundColor: `${AREAS.find((a) => a.id === user?.area)?.color || "#E5E5EA"}25`,
                        color: AREAS.find((a) => a.id === user?.area)?.color || "#94A3B8",
                      }}
                    >
                      {AREA_LABEL_MAP[user?.area || ""] || "Sin área"}
                    </Badge>
                    {user?.role === "admin" && (
                ...
                {user?.role === "admin" && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => setCurrentView("users")} className="cursor-pointer">
          ...
          <>
              ...
              <div className="flex gap-2">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" className="rounded-full border-border bg-card text-foreground hover:bg-muted">
                  ...
                  <DialogContent className="max-w-md rounded-2xl border-border bg-card">
                    <DialogHeader>
                      <DialogTitle className="text-lg text-foreground">Crear Flujo Manualmente</DialogTitle>
                    </DialogHeader>
                    <ManualCreateForm
            ...
            <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {[
                ...
                <Card key={stat.label} className="rounded-2xl border-border bg-card shadow-sm">
            ...
            {user?.role !== "admin" && myPendingWorkflows.length > 0 && (
              <div className="mb-8">
                <div className="mb-4 flex items-center gap-3">
                  <h3 className="text-lg font-semibold text-foreground">Mis Pendientes</h3>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  {myPendingWorkflows.slice(0, 3).map((workflow) => (
                    <Card
                      key={workflow.id}
                      className="group cursor-pointer rounded-2xl border-border bg-card shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5"
                      ...
                      <CardContent className="p-5">
                        <div className="mb-3 flex items-start justify-between">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-0.5 truncate text-xs text-muted-foreground">{workflow.documentName}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-[11px] text-muted-foreground">{workflow.fields?.length || 0} campos</span>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center">
              <div className="relative flex-1 sm:max-w-sm">
                ...
                <Input
                  ...
                  className="h-10 rounded-xl border-border bg-card pl-10 text-sm placeholder:text-muted-foreground/50"
                />
              </div>
            ...
            {isLoading ? (
              ...
              <Card className="rounded-2xl border-border bg-card shadow-sm">
                <CardContent className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">Sin flujos de trabajo</h3>
                  <p className="mt-1 text-sm text-muted-foreground">Crea tu primer flujo subiendo un formato o manualmente.</p>
                </CardContent>
              </Card>
            ) : (
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div className="space-y-4 pt-2">
      <div>
        ...
        <Input
          ...
          className="mt-1.5 h-10 rounded-xl border-border bg-background"
        />
      </div>
